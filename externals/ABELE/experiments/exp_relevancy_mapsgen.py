            ...
            try:
                ...
                for det in de_list:
                    if det == 'shapley_sampling':
                        relevancy = de.explain(det, target_tensor, input_tensor, xs, ys=ys, samples=10)[0]
                    else:
                        relevancy = de.explain(det, target_tensor, input_tensor, xs, ys=ys)[0]
                    ...
                    for color in [0, 127, 255]:
                        ...
                        print(datetime.datetime.now(),
                              ...
                              det, color, jrow_rel['color%s_c25' % color],
                              jrow_rel['color%s_c50' % color], jrow_rel['color%s_c75' % color]))
